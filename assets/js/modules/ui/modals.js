...
class ContactModal extends OverlayModal {
    ...
    constructor() {
        ...
        const content = Widget.div('contact-modal-content');

        {
            //Header
            const header = Widget.div('contact-modal-header');
...

        {
            ...
            const pRow = Widget.div('contact-row');

            pRow.addChild(new Widget('span', 'company-label').setText('Phone:'));
            pRow.addChild(new Widget('span').setInnerHtml(Consts.getPhoneHtml()));


            const nRow = Widget.div('contact-row');
            nRow.addChild(new Widget('span', 'company-label').setText('Email:'));
            nRow.addChild(new Widget('span').setInnerHtml(Consts.getEmailHtml()));

            content.addChild(rows.addChild(pRow, nRow));
        }
        {
